...
public class OP5_Word2QuestionScoring {
	...
	public static void main(String[] args){
		OP5_Word2QuestionScoring p=new OP5_Word2QuestionScoring("apache-poi");
		p.run();
	}
	
	public OP5_Word2QuestionScoring(String projectName){
