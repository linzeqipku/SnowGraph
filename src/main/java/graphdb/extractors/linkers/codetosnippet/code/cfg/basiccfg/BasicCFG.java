...
import graphdb.extractors.linkers.codetosnippet.code.cfg.SSACFGConverter;
import graphdb.extractors.linkers.codetosnippet.code.ir.IRRepresentation;
import graphdb.extractors.linkers.codetosnippet.code.ir.VariableUnit;
import graphdb.extractors.linkers.codetosnippet.code.ir.statement.IRAssignment;
import graphdb.extractors.linkers.codetosnippet.code.ir.statement.IRLabel;
...
public class BasicCFG implements CFG {
	private static Logger logger = Logger.getLogger("graphdb.extractors.linkers.codetosnippet.code.cfg.basiccfg.BasicCFG");
