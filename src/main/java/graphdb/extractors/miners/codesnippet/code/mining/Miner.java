...
import graphdb.extractors.miners.codesnippet.code.ir.statement.IRMethodInvocation;
...
public class Miner {
	public static Logger logger = Logger.getLogger("graphdb.extractors.miners.codesnippet.code.mining.Miner");
