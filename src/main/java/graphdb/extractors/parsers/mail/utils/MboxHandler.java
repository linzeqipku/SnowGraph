package graphdb.extractors.parsers.mail.utils;
...
import graphdb.extractors.parsers.mail.entity.MailInfo;
...
public class MboxHandler extends AbstractContentHandler {
    ...
    public static void createMailNode(Node node, String subject, String id, String senderName, String senderMail,
        ...
        node.setProperty(MailListExtractor.MAIL_SENDER_NAME, senderName);
        node.setProperty(MailListExtractor.MAIL_SENDER_MAIL, senderMail);
        node.setProperty(MailListExtractor.MAIL_RECEIVER_NAMES, String.join(", ", receiverNames));
