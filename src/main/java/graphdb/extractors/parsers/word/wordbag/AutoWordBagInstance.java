...
class AutoWordBagInstance {
	...
	private final static String	semanticTitlePath	= "data/wordbag/semantic/titles.txt";
	private final static String	semanticCellPath	= "data/wordbag/semantic/cells.txt";
