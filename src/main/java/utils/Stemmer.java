...
/**
 * Stemmer usage example
 * 
 * Stemmer stemmer = new Stemmer();
 * String[] strings = new String[] { "analysis", "analyse", "analysation" };
 * for (String s : strings)
 * {
 * 	stemmer.add(s.toCharArray(), s.length());
 * 	stemmer.stem();
 * 	System.out.println(stemmer.toString() + "\t" + s);
 * }
 * 
 * @author ������
 *
...
public class Stemmer
{
	...
	{
		Stemmer stemmer = new Stemmer();
		String[] strings = new String[] { "analysis", "analyse", "analyze",
